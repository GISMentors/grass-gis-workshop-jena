...
.. code-block:: bash
   ...
   i.modis.import -mw files=modis/listfileMOD11A2.061.txt outfile=tlist-mod.txt

   i.modis.import -mw files=modis/listfileMYD11A2.061.txt outfile=tlist-myd.txt
