...
interest is imported by :grasscmd:`v.import` (line :lcode:`62`),
resultant statistics is computed by :grasscmd:`t.rast.series` (line
:lcode:`68`) and :grasscmd:`r.univar` (line :lcode:`78`).
