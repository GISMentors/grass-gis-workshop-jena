...
We will add deleted lines back to the script.
...
After running a script, magic is done, and GUI dialog appears. This
...
.. figure:: ../images/units/12/ndvi-dialog-params.png
   ...
   GUI dialog including user options.
...
The ``clouds`` option is optional, so we will perform
