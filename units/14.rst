...
reference system (CRS) of input data differs from *jena-region* CRS
definition. GRASS will apply transformation of input data into target
CRS provided by the current location. This operation needs to be
confirmed by the users as shown in :numref:`confirm-reprojection`.
...
In many cases can help to set up a "reasonable" snapping threshold
before importing data into GRASS, see :numref:`import-snap`.
