...
The tools can be added to the existing model by |grass-tool-add|
:sup:`Add GRASS tool (tool) to model`. Note that newly added tools
...
:grasscmd:`r.recode` and :grasscmd:`r.colors` tools)
