...
.. note:: Note that :grasscmdaddons:`i.sentinel.download` requires
   also `sentinelsat library
   <https://pypi.python.org/pypi/sentinelsat>`__ to be
   installed. Sentinelsat library can be easily installed from the
...
<https://docs.sentinel-hub.com/api/latest/data/sentinel-2-l2a/>`__
