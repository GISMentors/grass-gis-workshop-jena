...
:ref:`grass-tools`) in the background. The GUI consists of two main
...
terminology *a project*) with user-defined spatial coordinate systems.
...
|grass-project-add| from the toolbar) the wizard appears. A new GRASS
