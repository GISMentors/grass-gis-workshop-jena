...
.. important:: Pre-downloaded Sentinel scenes are available in the
   ...
   with :ref:`importing sample data <sentinel-import-st>` section.

Let's download Sentinel L2A products for spring/summer 2025.

.. code-block:: bash
                
   i.sentinel.download -l settings=sentinel.txt map=jena_boundary area_relation=Contains \
   start=2025-04-01 end=2025-10-31 producttype=S2MSI2A clouds=10
...
Data can be imported by :grasscmdaddons:`i.sentinel.import` similarly as
...
.. tip:: GRASS supports mechanism of semantic labels which makes
