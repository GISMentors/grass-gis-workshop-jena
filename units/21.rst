...
.. code-block:: bash
   ...
   r.sentinel.download -l settings=sentinel.txt map=jena_boundary area_relation=Contains \
...
.. code-block:: bash
   ...
   r.sentinel.download settings=sentinel.txt map=jena_boundary area_relation=Contains \
